...
from openai_ros.task_envs.turtlebot2 import turtlebot2_position
...
if __name__ == '__main__':
    rospy.init_node('turtlebot2_position_deep_qlearn', anonymous=True, log_level=rospy.FATAL)
    env = gym.make('TurtleBot2Maze-v0')
    rospackage_name = "turtle2_openai_ros_example"
