...
#wandb.init(name='PPO1', project="reinforcement_test",entity="manhtran", sync_tensorboard=True)
...
class PPOAgent:
    ...
    def __init__(self, env_name, model_name=""):
        ...
        #self.Actor_name = "08_entropy_Env04_Critic_continuous_model.h5"
        #self.Critic_name = "08_entropy_Env04_Actor_continuous_model.h5"
    ...
    def test(self, test_episodes = 4):#evaluate
        self.load()
        print("state size:{}".format(self.action_size))
        s = 0
        i = 0
        goal = 0 ## index of goal 
        for e in range(test_episodes):
            ...
            while not done:
                ...
                # print("acion before re-parameterization:{}".format(action))
